    ...
    <div className="flex flex-col gap-5 pt-10 ">
      <div className="w-full flex flex-col gap-2 items-center ">
        ...
        <div className="max-w-[1000px] w-full px-2 lg:px-0">
          <h1 className="font-Poppins text-[27px] sm:text-[32px] md:text-[36px] text-center  xl:text-[42px] font-semibold">
        ...
        <div className="bg-black/40 relative flex w-full">
          <div className="container">
            <div className="flex flex-col gap-8 lg:gap-14  lg:flex-row  py-10  justify-between">
              <div className="xl:max-w-[780px] mx-auto border-[5px] border-[#fc7344] bg-[#f7f7f7] shadow-2xl rounded-2xl px-4 2xl:px-8 py-8 2xl:py-12 gap-6 w-full flex flex-col">
                ...
                <p className="text-[#9b9b9b] text-[13px] 2xl:text-[15px] text-center md:leading-6">
